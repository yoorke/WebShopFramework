...
{
    public class ProductImportEweV2DL : BaseProductImportDL
    {
        public ProductImportEweV2DL() : base("ewe")
        {
        ...
        protected override XmlDocument getXml(string category, string subcategory, GetParameter getParameter)
        {
            ...
            url.Append($"{supplierSettings.Url}?user={supplierSettings.Username}&secretcode={supplierSettings.Password}&currency=rsd&type=xml&pdv=0");
